							...
							<body>
								...
								<div id="web_chat_holder">
									...
									<div id="WebChatFormForm" style="overflow: auto; height: 200px;"></div>
										...
										<textarea id="WebChatTextID" placeholder="Send a message to online chat..." style="resize: none; max-height: 100px; width: 100%;margin-top:10px;display: block;" required></textarea>
